...
export const handler = async (event, context) => {
  ...
  if (source === 'com.kodinghut.dms.processing' && detailType === 'ProcessingFailed') {
    return handleProcessingFailed(event, context);
  }
  if (source === 'com.kodinghut.dms.comments' && detailType === 'CommentAdded') {
