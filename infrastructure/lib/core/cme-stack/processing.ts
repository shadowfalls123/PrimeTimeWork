...
export class DocumentProcessing extends Construct {
  ...
  constructor(scope: Construct, id: string, props: DocumentProcessingProps) {
    ...
    const getDocumentMetadata = new NodejsServiceFunction(
      this,
      "MetadataLambda",
      {
    ...
    getDocumentMetadata.addEnvironment(
      "UPLOAD_BUCKET",
    ...
    const getDocumentMetadataInvoke = new tasks.LambdaInvoke(
      this,
    ...
    createThumbnail.addEnvironment(
      "UPLOAD_BUCKET",
      props.uploadBucket.bucketName
    );
    createThumbnail.addEnvironment(
    ...
    const createThumbnailInvoke = new tasks.LambdaInvoke(
      this,
    ...
    const startTextDetection = new NodejsServiceFunction(
      this,
      "StartTextDetectionLambda",
      {
        entry: path.join(
          __dirname,
          "../../../services/processing/startTextDetection.js"
        ),
      }
    );

    startTextDetection.addEnvironment(
      "UPLOAD_BUCKET",
      props.uploadBucket.bucketName
    );
    ...
    const startTextDetectionInvoke = new tasks.LambdaInvoke(
      this,
      "Start Text Detection Process",
      {
    ...
    const getTextDetectionResults = new NodejsServiceFunction(
      this,
      "GetTextDetectionLambda",
      {
        entry: path.join(
          __dirname,
          "../../../services/processing/parseTextDetectionResults.js"
        ),
    ...
    const insertDocument = new NodejsServiceFunction(
      this,
      "InsertDocumentLambda",
      {
        entry: path.join(__dirname, "../../../services/processing/insert.js"),
      }
    );

    insertDocument.addEnvironment(
    ...
    const insertDocumentInvoke = new tasks.LambdaInvoke(
      this,
    ...
    const catchErrorInvoke = new tasks.LambdaInvoke(
      this,
      "Unable to process - Rollback all data",
      {
    ...
    const isTextDetectionCompletedChoice = new sfn.Choice(
      this,
      "Has Text Detection Completed",
      {}
    );
    isTextDetectionCompletedChoice
      .when(
        sfn.Condition.stringEquals("$.textDetection.jobStatus", "SUCCEEDED"),
        pass
      )
      .otherwise(waitStep);
    ...
    this.processingStateMachine = new sfn.StateMachine(
      this,
